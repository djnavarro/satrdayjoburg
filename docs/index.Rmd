...
The current version of the course is not *quite* complete (my slides are missing and one set of exercises isn't done yet) but it should cover most of the workshop content.
