...
.column.bg-main3[.content.vtop.center[
.pad1[.font2[
```{r add_theme2222, eval=TRUE, message = FALSE, echo=FALSE, cache=TRUE, warning=FALSE}
ggplot(
  data = beaches,
  mapping = aes(x = temp_airport) 
) +  
...
.column.bg-main3[.content.vtop.center[
.pad1[.font2[
```{r add_titles222, eval=TRUE, message = FALSE, echo=FALSE, cache=TRUE, warning=FALSE}
ggplot(
  data = beaches,
  mapping = aes(x = temp_airport) 
) +  
